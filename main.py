...
async def mines(ctx, round_id):
    ...
    if round_length < 36:
        ...
        # Alle logica voor het mijnenspel blijft hetzelfde
        ...
        pfp = 'https://cdn.discordapp.com/emojis/1277052967144652945.gif?size=160&quality=lossless'
...
# Gebruik omgevingsvariabele om de token te laden
